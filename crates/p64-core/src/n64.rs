...
pub fn run_game(file_path: &std::path::Path, device: &mut N64, width: u32, height: u32, fullscreen: bool) {
    ...
    start_window(&mut device.ui, rdram_ptr, rdram_size, width, height, fullscreen);
